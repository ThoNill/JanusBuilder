...
public class AppBuilder {
	...
	public void addDataModel(JanusApplication app,String filename) throws Exception {
	...
	private JanusPage createDataModelFromFile(String dir,String pagename)
		...
		org.jdom2.Document page = new XMLDocumentLoader().createDocument(dir + pagename + ".xml");
